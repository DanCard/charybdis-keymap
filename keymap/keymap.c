...
[3] = LAYOUT(
  ...
  KC_SEL_LOCK    , CM_MS_UL  , CM_MS_UP   , CM_MS_UR   , MS_BTN2, KC_EXIT,   KC_EXIT, MS_WHLU      , MS_WHLU, KC_EXIT, KC_SEL_LOCK, QK_CLEAR_EEPROM,
  KC_EXIT        , CM_MS_LEFT, SCROLL_MODE, CM_MS_RIGHT, MS_BTN1, MS_BTN2,   KC_MOUSE_LOCK, MS_BTN1, MS_BTN3, SCROLL_MODE, MS_BTN2, KC_EXIT,
